...
SCRIPTS_MAP = {
    ...
    "INVALID_NAME": "အမည်လေး မမှန်သေးပါရှင်။ ကျေးဇူးပြု၍ အမည်မှန်ကို ပြန်ပေးပါဦးရှင်။",
    "INVALID_PHONE": "ဖုန်းနံပါတ်လေးက မှားနေပါတယ်ရှင်။ တချက်ပြန်စစ်ပြီး မှန်ကန်တဲ့ ဖုန်းနံပါတ်ကို ပြန်ပေးပါဦးရှင်။",
    "INVALID_ADDRESS": "လိပ်စာလေး မပြည့်စုံသေးပါရှင်။ အပြည့်အစုံကို ပြန်ပေးပါဦးရှင်။",
    "INVALID_TOWNSHIP": "ဒီမြို့နယ်ကို ပို့ဆောင်ပေးနိုင်မပေးနိုင် စစ်ဆေးမရသေးပါရှင်။ မှန်ကန်တဲ့ မြို့နယ်ကို ပြန်ပေးပါဦးရှင်။",
    ...
    "RATE_LIMIT_EXCEEDED": "စိတ်မကောင်းပါဘူးရှင်။ အခုချိန်မှာ မက်ဆေ့ချ်တွေ အရမ်းများနေလို့ ခဏနားပြီးမှ ပြန်ပို့ပေးပါဦးရှင်။ 🙏"
}
